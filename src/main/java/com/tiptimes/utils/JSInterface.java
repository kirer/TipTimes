...
import com.tiptimes.common.TTAct;
import com.tiptimes.common.TTFrag;
...
public class JSInterface {
    ...
    private TTAct mContext;
    private TTFrag mFragment;

    public JSInterface(TTFrag mFragment) {
        this.mFragment = mFragment;
        this.mContext = (TTAct) mFragment.getActivity();
    }

    public JSInterface(TTAct mContext) {
